...
export const ambiguousIntakeResponseSchema = z.object({
  error: z.string().min(1),
  tenantIds: z.array(z.string().min(1)).min(2),
});
...
export type AmbiguousIntakeResponse = z.infer<typeof ambiguousIntakeResponseSchema>;
