...
for (const chapter of chapters) {
  ...
  const tempo = Math.max(1, length / available);
  if (tempo > 1.06)
    throw new Error(
...
ffmpeg([
  ...
  bed,
  "-af",
  "atrim=duration=120,loudnorm=I=-35.5:TP=-9:LRA=7,afade=t=in:d=1.2,afade=t=out:st=117:d=3",
  "-ar",
  "48000",
  "-ac",
  "2",
...
ffmpeg([
  ...
  resolve(out, "music.wav"),
  "-filter_complex",
  "[0:a]asplit=2[voice][side];[1:a][side]sidechaincompress=threshold=0.08:ratio=1.5:attack=35:release=350[ducked];[voice][ducked]amix=inputs=2:normalize=0,alimiter=limit=0.95:level=false[mix]",
  "-map",
  "[mix]",
  "-c:a",
  "aac",
...
process.stdout.write(
  "Mixed two-minute demo; music target 19.5 LU below narration, with gentle speech ducking\n",
);
